...
import { Access } from "../../access/base/Access";
...
export class PolicyResolverBase {
  ...
  @graphql.ResolveField(() => Access, {
    nullable: true,
    name: "access",
  })
  async getAccess(@graphql.Parent() parent: Policy): Promise<Access | null> {
    const result = await this.service.getAccess(parent.id);
